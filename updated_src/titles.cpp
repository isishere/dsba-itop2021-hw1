...
void Titles::addNewFilmToModel(const QPair<QString, TBasics>& pairTitleAtts)
{
    _mapTitleAtts.insert(pairTitleAtts.first, pairTitleAtts.second);

    emit  filmAdded();
}

void Titles::deleteFilmFromModel(const QString title)
{
    _mapTitleAtts.remove(title);
